# Alberta Fiscal Plan 2026-2029: Revenue and Expense Analysis

## Prepared by Kacper Ruta, Policy & Fiscal Analysis | February 2026
...
![Fiscal Balance Waterfall: From Surplus to Sustained Deficit](plots/fiscal_balance_waterfall.png)
...
![Revenue vs. Expense Divergence](plots/scissors_effect.png)
...
![Revenue Composition by Category](plots/revenue_composition.png)
...
![Resource Revenue Decline Trajectory](plots/revenue_resource_risk.png)
...
Resource revenue's share of total revenue drops from 26.7 percent in 2024-25 to 17.7 percent in 2026-27, shifting the revenue base toward tax revenue and federal transfers -- more predictable but more constrained in growth potential.

![Revenue Composition: 2024-25 vs. 2026-27](plots/revenue_dependency_comparison.png)
...
|---|---|---|
| 1 | Hospital & Surgical Services | >$13B |
| 2 | Education & Childcare | >$13B |
| 3 | Primary & Preventative Health | >$12B |
| 4 | Assisted Living & Home Care | >$12B |

![Ministry Spending Rankings](plots/expense_ministry_ranking.png)
...
![Where Each Revenue Dollar Goes](plots/per_dollar_breakdown.png)

### 3.2 Biggest Spending Changes

The three largest spending increases are:

- **Hospital & Surgical Services:** +$2.3 billion (+20.4%), reflecting demand pressures in acute care, surgical wait-list reduction initiatives, and health workforce cost escalation.
- **Education & Childcare:** +$2.0 billion (+17.7%), driven by enrollment growth, the expansion of early childhood programs, and negotiated compensation increases.
- **Assisted Living & Home Care:** +$1.95 billion (+19.0%), attributable to demographic pressures from an aging population and expanded community-based care models.

The two largest spending decreases are:

- **Agriculture & Irrigation:** -$1.0 billion (-51.6%), reflecting the wind-down of emergency drought and livestock assistance programs.
- **Forestry & Parks:** -$668 million (-61.3%), attributable to the conclusion of extraordinary wildfire suppression expenditures.

These decreases reflect the natural expiry of time-limited disaster response spending, not policy-driven restraint.

![Biggest Spending Increases and Decreases](plots/expense_changes_tornado.png)
...
![Expense Composition by Policy Category](plots/expense_composition_categories.png)
...
![Expense Growth Rate vs. Budget Size](plots/expense_growth_vs_size.png)

### 3.4 Health Spending Deep Dive

Three health ministries (Hospital & Surgical, Primary & Preventative, Assisted Living & Home Care) collectively form the largest spending block, rising from 34.8 percent to 38.1 percent of total program expense -- progressively crowding out other priorities.

![Health Spending: Three Ministries Over Time](plots/health_spending_deep_dive.png)

This trajectory reflects structural factors -- population growth, aging demographics, workforce compensation, and pharmaceutical costs -- unlikely to abate without deliberate policy intervention.
...
![Revenue vs. Expense Gap with Annual Deficit](plots/revenue_vs_expense_gap.png)
...
![Cumulative Deficit and New Borrowing Requirements](plots/cumulative_deficit.png)
...
![Taxpayer-Supported Debt Growth](plots/debt_trajectory.png)
...
![Debt Servicing Cost Escalation](plots/debt_servicing_escalation.png)
...
The following findings emerge from the analysis of the 2026-2029 Fiscal Plan:

1. **Structural deficit of $9.4 billion projected for 2026-27.** The deficit is not cyclical in nature but reflects a fundamental misalignment between the province's revenue capacity and its expenditure commitments. Even with partial revenue recovery, deficits persist through the entire plan period.

2. **Bitumen royalty revenue declines by $7.5 billion (43.6%), representing the single largest revenue shock.** The concentration of fiscal risk in a single commodity stream remains the province's most significant structural vulnerability.

3. **Resource revenue's share of total revenue falls from 26.7% to 17.7%.** This shift occurs not through deliberate diversification but through the contraction of the commodity revenue base, leaving the province with a narrower and less robust revenue structure.

4. **Tax revenue growth of 9.3% is materially insufficient to offset the resource revenue decline.** The $2.8 billion gain in tax revenue covers less than one-third of the $8.8 billion resource revenue loss.

5. **Total operating expenditure grows by 20% over the plan period, driven by health, education, and social services.** These three policy areas account for approximately 60 percent of all program spending and are subject to structural demand pressures that are unlikely to moderate without policy intervention.

6. **Health care spending rises from 34.8% to 38.1% of program expense, progressively crowding out other priorities.** The three health ministries collectively represent the largest and fastest-growing area of government expenditure.

7. **Taxpayer-supported debt grows by 61%, from $85.2 billion to $137.5 billion.** This trajectory, if sustained, would fundamentally alter Alberta's fiscal position relative to other Canadian provinces.

8. **Debt servicing costs escalate by 51% to $4.9 billion annually, exceeding 21 of 26 ministry budgets.** The compound effect of rising debt and rising interest costs creates a self-reinforcing fiscal constraint.

9. **Net financial assets decline from $24.5 billion to negative $3.5 billion.** The transition to a negative net asset position represents the exhaustion of the province's accumulated fiscal buffers.

10. **For every dollar of revenue collected, the province spends $1.13, producing a 13-cent-per-dollar structural deficit.** This metric captures, in its simplest terms, the magnitude of the fiscal adjustment required to restore balance.
...
Data processing and visualization were performed using Python 3 (pandas, seaborn, matplotlib). Figures reflect the government's own projections; this analysis does not apply independent economic or commodity price forecasts. Year-over-year changes reference the 2024-25 actual unless otherwise specified.
